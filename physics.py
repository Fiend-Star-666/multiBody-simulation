...
def handle_ball_collision(self_ball, other_ball):
    ...
    if distance < self_ball.radius + other_ball.radius:
        ...
        if self_ball.sound:
            pygame.mixer.Sound.play(pygame.mixer.Sound(self_ball.sound))
...
def handle_ball_collision_new(self_ball, other_ball):
    ...
    if distance < self_ball.radius + other_ball.radius:
        ...
        logging.debug(
            f"Other ball normal velocity: {other_ball_velocity_normal}, tangent velocity: {other_ball_velocity_tangent}")
